...
extension XcodeBuild.BuildSetting {
    ...
    public static func activeBuildAction(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func alternateInstallGroup(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func alternateInstallPermissions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func alternateInstallOwner(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func requireOnlyAppExtensionSafeAPI(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func convertCopiedFiles(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func architectures(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func assetCatalogAppIconSetName(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func watchComplicationName(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func assetCatalogLaunchImageSetName(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func leaderboardIdentifierPrefix(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func leaderboardSetIdentifierPrefix(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func optimization(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func stickerPackIdentifierPrefix(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func showAssetCatalogNotices(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func showAssetCatalogWarnings(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func activeBuildComponents(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enableCContainerOverflowChecks(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func allowNonmodularIncludesInFrameworkModules(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func deadStores(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func misuseofGrandCentralDispatch(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func missingLocalizationContextComment(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func missingLocalizability(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func improperMemoryManagement(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func misuseofnonnull(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func suspiciousConversionsofNSNumberandCFNumberRef(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func synchronizedwithnilmutex(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func misuseofCollectionsAPI(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func improperInstanceCleanupindealloc(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func misuseofObjectiveCgenerics(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "CLANG_ANALYZER_OBJC_GENERICS", value: value)
    }
    /// Warn about Objective-C method signatures with type incompatibilities.
    public static func methodSignaturesMismatch(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func improperHandlingofCFErrorandNSError(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func violationofReferenceCountingRules(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func violationofselfsuperinitRule(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "CLANG_ANALYZER_OBJC_SELF_INIT", value: value)
    }
    /// Warn about private ivars that are never used.
    public static func unusedIvars(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "CLANG_ANALYZER_OBJC_UNUSED_IVARS", value: value)
    }
    /// Check for potential buffer overflows.
    public static func eXPERIMENTALBufferoverflows(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "CLANG_ANALYZER_SECURITY_BUFFER_OVERFLOW_EXPERIMENTAL", value: value)
    }
    /// Warn on using a floating point value as a loop counter (CERT: FLP30-C, FLP30-CPP).
    public static func floatingPointValueUsedasLoopCounter(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func useofgetpwgets(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func useofmktemporPredictablemktemps(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func useofrandFunctions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func useofstrcpyandstrcat(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func uncheckedReturnValues(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func useofvfork(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func misuseofKeychainServicesAPI(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func cxxLanguageDialect(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "CLANG_CXX_LANGUAGE_STANDARD", value: value)
    }
    /// Choose a version of the C++ standard library to use.- *libstdc++:* A traditional C++ standard library that works with GCC and the LLVM Compiler (default).- *libc++:* A highly optimized C++ standard library that works only with the LLVM Compiler, and is designed to support new C++11 features.
    public static func cStandardLibrary(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func debugInformationLevel(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enableCodeCoverageSupport(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enableModules(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enableClangModuleDebugging(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func objectiveCAutomaticReferenceCounting(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func weakReferencesinManualRetainRelease(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func implicitlyLinkObjectiveCRuntimeSupport(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func addattributeannotations(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func inferinstancetypeformethodresulttype(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func useNSENUMNSOPTIONSmacros(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func inferdesignatedinitializermethods(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func objCliterals(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func objCsubscripting(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func atomicityofinferredproperties(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "CLANG_MIGRATOR_PROPERTY_ATOMICITY", value: value)
    }
    /// Enable migration of setter/getter messages to property-dot syntax.
    public static func objCpropertydotsyntax(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func inferprotocolconformance(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func onlymodifypublicheaders(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func inferreadonlyproperties(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func inferreadwriteproperties(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func linkFrameworksAutomatically(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func optimizationProfileFile(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func modeofAnalysisforBuild(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func modeofAnalysisforAnalyze(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enableExtraIntegerChecks(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enableNullabilityAnnotationChecks(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func useOptimizationProfile(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func outofRangeEnumAssignments(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func blockCaptureofAutoreleasing(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func implicitBooleanConversions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func suspiciousCommas(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func implicitConstantConversions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func usingC11extensionsinearlierversionsofC(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func overridingDeprecatedObjectiveCMethods(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func directusageofisa(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func documentationComments(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "CLANG_WARN_DOCUMENTATION_COMMENTS", value: value)
    }
    /// Warn about loop bodies that are suspiciously empty.
    public static func emptyLoopBodies(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func implicitEnumConversions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func implicitFloatConversions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func implicitSignednessConversions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func infiniteRecursion(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func implicitIntegertoPointerConversions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func implicitNonLiteralNullConversions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func incorrectUsesofNullableValues(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func implicitownershiptypesonoutparameters(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func implicitAtomicObjectiveCProperties(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func implicitretainofselfwithinblocks(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func implicitObjectiveCLiteralConversions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func implicitSynthesizedProperties(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func repeatedlyusingaweakreference(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func unintentionalRootClass(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "CLANG_WARN_OBJC_ROOT_CLASS", value: value)
    }
    /// Warn about ranged-based for loops.
    public static func rangebasedForLoops(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "CLANG_WARN_RANGE_LOOP_ANALYSIS", value: value)
    }
    /// Warn about non-prototype declarations.
    public static func strictPrototypes(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func suspiciousImplicitConversions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func suspiciousMoves(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func unguardedavailability(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func unreachableCode(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func usingbridgeCastsOutsideofARC(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "CLANG_WARN__ARC_BRIDGE_CAST_NONARC", value: value)
    }
    /// Warn about declaring the same method more than once within the same `@interface`.
    public static func duplicateMethodDefinitions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func exitTimeCDestructors(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enableAdditionalVectorExtensions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func codeSigningEntitlements(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func codeSigningIdentity(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func combineHighResolutionArtwork(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enableIndexWhileBuildingFunctionality(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func perconfigurationBuildProductsPath(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func perconfigurationIntermediateBuildFilesPath(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func preserveHFSData(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func rununifdefonProductHeaders(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func unifdefFlagsforProductHeaders(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func stripDebugSymbolsDuringCopy(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func coreMLModelClassGenerationLanguage(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func coreMLGeneratedModelInheritsNSObject(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func cppPrefixFile(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func outputLogLevel(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func distillationMode(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func installationBuildProductsLocation(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func otherDTraceFlags(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func compatibilityVersion(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func currentLibraryVersion(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func dynamicLibraryInstallNameBase(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enableFoundationAssertions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func buildActiveResourcesOnly(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enableStrictCheckingofobjcmsgSendCalls(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func subDirectoriestoExcludeinRecursiveSearches(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func charTypeIsUnsigned(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func codeWarriorMSStyleInlineAssembly(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func cLanguageDialect(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func generatePositionDependentCode(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func allowasminlinetypeof(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func recognizeBuiltinFunctions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enableCExceptions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enableCRuntimeTypes(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enableExceptions(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "GCC_ENABLE_EXCEPTIONS", value: value)
    }
    /// Generate output containing library calls for floating point.
    public static func generateFloatingPointLibraryCalls(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func kernelDevelopmentMode(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enableObjectiveCExceptions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func recognizePascalStrings(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enableSSE3Extensions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enableSSE41Extensions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enableSSE42Extensions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enableTrigraphs(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func relaxIEEEComplianceForGCC(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func generateDebugSymbols(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func generateLegacyTestCoverageFiles(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func increaseSharingofPrecompiledHeaders(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func inlineMethodsHidden(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func compileSourcesAs(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func instrumentProgramFlow(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enableLinkingWithSharedLibraries(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func precompilePrefixHeader(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func prefixHeader(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "GCC_PREFIX_HEADER", value: value)
    }
    /// Space-separated list of preprocessor macros of the form `foo` or `foo=bar`.
    public static func preprocessorMacros(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func preprocessorMacrosNotUsedInPrecompiledHeaders(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "GCC_PREPROCESSOR_DEFINITIONS_NOT_USED_IN_PRECOMPS", value: value)
    }
    /// Reuse string literals.
    public static func makeStringsReadOnly(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func shortEnumerationConstants(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enforceStrictAliasing(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func symbolsHiddenbyDefault(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func staticsareThreadSafe(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func treatMissingFunctionPrototypesasErrors(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func treatIncompatiblePointerTypeWarningsasErrors(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func treatGCCWarningsasErrors(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func unrollLoops(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func useStandardSystemHeaderDirectorySearching(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func compilerforCCObjectiveC(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func implicitConversionto32BitType(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func deprecatedFunctions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func undefinedUseofoffsetofMacro(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func missingFieldsinStructureInitializers(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func missingNewlineAtEndOfFile(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func missingFunctionPrototypes(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func pointerSignComparison(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func mismatchedReturnType(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func incompleteObjectiveCProtocols(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func checkSwitchStatements(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func fourCharacterLiterals(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func overloadedVirtualFunctions(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "GCC_WARN_HIDDEN_VIRTUAL_FUNCTIONS", value: value)
    }
    /// Inhibit all warning messages.
    public static func inhibitAllWarnings(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func initializerNotFullyBracketed(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func missingBracesandParentheses(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func nonvirtualDestructor(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func pedanticWarnings(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func hiddenLocalVariables(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func signComparison(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func strictSelectorMatching(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func typecheckCallstoprintfscanf(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func undeclaredSelector(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func uninitializedVariables(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func unknownPragma(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func unusedFunctions(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "GCC_WARN_UNUSED_FUNCTION", value: value)
    }
    /// Warn whenever a label is declared but not used.
    public static func unusedLabels(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "GCC_WARN_UNUSED_LABEL", value: value)
    }
    /// Warn whenever a function parameter is unused aside from its declaration.
    public static func unusedParameters(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "GCC_WARN_UNUSED_PARAMETER", value: value)
    }
    /// Warn whenever a statement computes a result that is explicitly not used.
    public static func unusedValues(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func unusedVariables(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func performSingleObjectPrelink(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func forcePackageInfoGeneration(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enableTextBasedStubsGeneration(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func autoActivateCustomFontsForIbcCompiler(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func showIbcErrors(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func flattenCompiledXIBFiles(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func defaultIBCModule(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "IBC_MODULE", value: value)
    }
    /// Show notices encountered during the compilation of XIB files.
    public static func showIbcNotices(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func otherInterfaceBuilderCompilerFlags(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func overridingPlugInandFrameworkDirectory(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func plugIns(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func plugInSearchPaths(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func stripNIBFiles(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func showIbcWarnings(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func autoActivateCustomFontsForIbscCompiler(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func showIbscErrors(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func flattenCompiledStoryboardFiles(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "IBSC_FLATTEN_NIBS", value: value)
    }
    /// Defines the module name for Swift classes referenced without a specific module name.
    public static func defaultIBSCModule(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func showIbscNotices(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "IBSC_NOTICES", value: value)
    }
    /// A list of additional flags to pass to the Interface Builder Compiler. Use this setting if Xcode does not already provide UI for a particular Interface Builder Compiler flag.
    public static func otherStoryboardCompilerFlags(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func stripStoryboardcFiles(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func showIbscWarnings(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func subDirectoriestoIncludeinRecursiveSearches(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func expandBuildSettingsinInfoplistFile(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func infoplistOutputEncoding(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func infoplistPreprocessorPrefixFile(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func preprocessInfoplistFile(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func initializationRoutine(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "INIT_ROUTINE", value: value)
    }
    /// Enables private framework inlining for Text-Based Stubs.
    public static func enableTextBasedStubsInlining(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func performCopyFilesPhasesDuringinstallhdrs(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func performShellScriptPhasesDuringinstallhdrs(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func installPermissions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func installationDirectory(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func preservePrivateExternalSymbols(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func pathtoLinkerDependencyInfoFile(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func dynamicLibraryInstallName(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func writeLinkMapFile(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func pathtoLinkMapFile(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func generatePositionDependentExecutable(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func quoteLinkerArguments(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func runpathSearchPaths(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func otherLexFlags(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func generateCaseInsensitiveScanner(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func suppressDefaultRule(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func suppressWarningMessages(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func displayMangledNames(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func linkTimeOptimization(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func macOSDeploymentTarget(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func suppressallmapcwarnings(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func privateModuleMapFile(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func moduleIdentifier(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func moduleStartRoutine(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func moduleStopRoutine(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func suppressmomcwarningsfordeleterules(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func suppressmomcwarningsonmissinginverserelationships(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func suppressmomcwarningsforentitieswithmorethan100properties(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func suppressallmomcwarnings(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func suppressmomcerrorontransientinverserelationships(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func otherMetalLinkerFlags(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "MTLLINKER_FLAGS", value: value)
    }
    /// Space-separated list of compiler flags
    public static func otherMetalCompilerFlags(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func producedebugginginformation(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func enablefastmath(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func ignoreWarnings(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func metallanguagerevision(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    /// Space-separated list of preprocessor macros of the form "foo" or "foo=bar".
    public static func preprocessorDefinitions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func treatMTLWarningsasErrors(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func otherNasmFlags(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func intermediateBuildFilesPath(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "OBJROOT", value: value)
    }
    /// If enabled, only the active architecture is built.
    public static func buildActiveArchitectureOnly(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func openCLArchitectures(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func autovectorizer(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func flushdenormstozero(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func doubleassingle(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func relaxIEEEComplianceForOpenCL(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func openCLOtherFlags(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "OPENCL_OTHER_BC_FLAGS", value: value)
    }
    /// Space-separated list of preprocessor macros of the form `foo` or `foo=bar`.
    public static func openCLPreprocessorMacros(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func saveasExecuteOnly(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func otherCodeSigningFlags(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func otherCXXFlags(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func otherLinkerFlags(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func otherLibrarianFlags(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func otherTextBasedInstallAPIFlags(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func propertyListOutputEncoding(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func precompiledHeaderUsesFilesFromBuildDirectory(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func singleObjectPrelinkFlags(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func prelinklibraries(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func dontDeadStripInitsandTerms(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func preinstallRequirementsPropertyList(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    /// The UUID of a valid provisioning profile. A missing or invalid profile will cause a build error.This build setting is deprecated. Use [Provisioning Profile (PROVISIONING_PROFILE_SPECIFIER)](https://help.apple.com/xcode/mac/current/#/itcaec37c2a6?sub=devb5b06a8dd) instead.
    ...
    public static func fileForkofBinarySources(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func preprocessorDefines(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func preprocessorUndefines(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func resolveAliases(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func readonlyResourceMap(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func showDiagnosticOutput(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func suppressTypeRedeclarationWarnings(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func analyzeDuringBuild(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func baseSDK(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func symbolOrderingFlags(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func separatelyEditSymbols(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func precompiledHeadersCachePath(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func additionalStripFlags(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func stripLinkedProduct(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func removeTextMetadataFromPNGFiles(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func supportsTextBasedInstallAPI(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "SUPPORTS_TEXT_BASED_API", value: value)
    }
    /// A list of compilation conditions to enable for conditional compilation expressions.
    public static func activeCompilationConditions(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func disableSafetyChecks(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "SWIFT_DISABLE_SAFETY_CHECKS", value: value)
    }
    /// Enforce exclusive access to memory
    public static func exclusiveAccesstoMemory(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func importPaths(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func installObjectiveCCompatibilityHeader(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func objectiveCBridgingHeader(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func objectiveCGeneratedInterfaceHeaderName(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "SWIFT_OBJC_INTERFACE_HEADER_NAME", value: value)
    }
    /// - *None:* Compile without any optimization. `-Onone`- *Fast, Single-File Optimization:* `-O`- *Fast, Whole Module Optimization:* `-O -whole-module-optimization`
    ...
    public static func precompileBridgingHeader(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "SWIFT_PRECOMPILE_BRIDGING_HEADER", value: value)
    }
    /// This setting controls the level of reflection metadata the Swift compiler emits.- *All:* Type information about stored properties of Swift structs and classes, Swift enum cases, and their names, are emitted into the binary for reflection and analysis in the Memory Graph Debugger.- *Without Names:* Only type information about stored properties and cases are emitted into the binary, with their names omitted. `-disable-reflection-names`- *None:* No reflection metadata is emitted into the binary. Accuracy of detecting memory issues involving Swift types in the Memory Graph Debugger will be degraded and reflection in Swift code may not be able to discover children of types, such as properties and enum cases. `-disable-reflection-metadata`
    public static func reflectionMetadataLevel(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "SWIFT_REFLECTION_METADATA_LEVEL", value: value)
    }
    /// Don't emit any warnings.
    public static func suppressWarnings(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func swift3objcInference(_ value: String) -> XcodeBuild.BuildSetting {
        return XcodeBuild.BuildSetting(name: "SWIFT_SWIFT3_OBJC_INFERENCE", value: value)
    }
    /// Treat all warnings as errors.
    public static func treatSwiftWarningsasErrors(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func buildProductsPath(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func textBasedInstallAPIVerificationMode(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func textBasedInstallAPIFile(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func useHeaderMaps(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func validateBuiltProduct(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func validArchitectures(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func versioningUsername(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func generatedVersioningVariables(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func generatedVersioningSourceFilename(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func versioningNamePrefix(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func versioningNameSuffix(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func otherWarningFlags(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func warningLinkerFlags(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func appendPluginData(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func copyOriginalPluginData(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func includeExtensionXML(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func pluginDataFormat(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func pluginMaximumDeveloperToolsVersion(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func pluginMinimumDeveloperToolsVersion(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func otherYaccFlags(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func generatedFileStem(_ value: String) -> XcodeBuild.BuildSetting {
    ...
    public static func generateDebuggingDirectives(_ value: String) -> XcodeBuild.BuildSetting {
                ...
                if comps.count == 2 {
                    let str_no_white_s = comps[0]
                        .replacingOccurrences(of: " ",
                                              with: "")
                    let func_name_comps = str_no_white_s
                        .components(separatedBy: CharacterSet(charactersIn: "()"))
                        .filter({ $0.lengthOfBytes(using: .utf8) > 0 })
                    let func_name = func_name_comps.first!
                        .filter({ !"~!@#$%^&*()_-+=`{}|[]\\:\";'<>?,./".contains($0) })
                    ...
                    \t/// \(comps[1]
                            .replacingOccurrences(of: "\n", with: ""))
                    \tpublic static func \({ () -> String in
                        return String(func_name.first!).lowercased()
                             + func_name.dropFirst()
                    }())(_ value: String) -> XcodeBuild.BuildSetting {
                          \treturn XcodeBuild.BuildSetting(name: "\(func_name_comps.last!)", value: value)
                    \t}
                    """
                }
            })
